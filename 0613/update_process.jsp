		...
		try {
			...
			if (rs.next()) {
				...
				if (before.equals(depart)) {
					...
					pstmt.executeUpdate();
					out.println("<div class=\"alert alert-primary\" role=\"alert\">Student2 테이블을 수정했습니다.</div>");
				} else
					out.println("<div class=\"alert alert-danger\" role=\"alert\">Student2 테이블을 수정하지 못했습니다.</div>");
			} else
